//Tests taken from OpenZeppelin, modified for factory generation
...
contract('Crowdsale', function ([_, investor, wallet, purchaser]) {
  ...
  beforeEach(async function () {
    ...
    var crowdsaleCreation = await factory.createCrowdsale(this.startTime, this.endTime, rate, wallet, [], []);
    for (var i = 0; i < crowdsaleCreation.logs.length; i++) {
      var log = crowdsaleCreation.logs[i];
      if(log.event == "CrowdsaleCreated") {
        this.crowdsale = Crowdsale.at(log.args.addr);
      }
    }
